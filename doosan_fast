    ...
    try:
        ...
        if status == 1:
            ...
            if classification == 'xl':
                ...
                time.sleep(2)
                sock.sendall(
                    f"movel(posx({x + check_position()}, {y + check_position()}, {z + 275}, 168.5, -177.8, -11.9), v=1000, a=1000)".encode())
                time.sleep(2)
                sock.sendall(
                    f"movel(posx({x+ check_position()/2}, {y + check_position()/2}, {z + 10}, 168.5, -177.8, -11.9), v=1000, a=1000)".encode())
                time.sleep(2)
                sock.sendall(
            ...
            time.sleep(2)
            sock.sendall(b"movel(posx(-135.9, 609.5, 509.1,  168.8, -178.0, -11.6), v=1000, a=1000)")
            time.sleep(2)
            status = 0
            sock.sendall(b"movel(posx(559.0, -56.8, 661.1, 169.3, 180.0, -10.7), v=1000, a=1000)")
            time.sleep(4)
